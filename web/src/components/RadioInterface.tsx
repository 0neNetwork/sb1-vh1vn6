...
const RadioInterface: React.FC = () => {
  ...
  const changeStation = (station: string) => {
    ...
    fetch('https://car-radio/changeStation', {
      method: 'POST',
  ...
  return (
    <div className="space-y-4 fade-in">
      ...
      <div className="space-y-2">
        <div className="flex items-center space-x-2">
          ...
          <button 
            ...
            onClick={() => changeStation(customLink)}
          >
            <Link size={16} />
          </button>
        </div>
      ...
      <div className="flex justify-center space-x-4 mt-4">
        <a href="#" onClick={() => changeStation('YouTube Music')} className="text-red-500 hover:text-red-400 transition-all">
          <Youtube size={24} />
        </a>
        <a href="#" onClick={() => changeStation('Spotify')} className="text-green-500 hover:text-green-400 transition-all">
          <Music size={24} />
        </a>
      </div>
    </div>
